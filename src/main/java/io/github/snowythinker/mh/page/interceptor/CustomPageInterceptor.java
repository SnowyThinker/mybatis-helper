...
public class CustomPageInterceptor implements CustomInterceptor{
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        List<?> dataList = (List<?>) invocation.proceed();
        return new PageQueryResponse<>(dataList, totalCount, pageSize, currentPage);
    }
...
//		return CustomInvocationHandler.wrap(arg0, this);
    }
